...
def __changeRes1__():
    ...
    __titleTextSize__ = int(77/2)
    __button__TextSize = int(20/2)
    displayWidth = 480
    displayHeight = 320
    play(displayWidth, displayHeight)
...
def __changeRes2__():
    ...
    global __button__TextSize
    global __titleTextSize__
    __titleTextSize__ = int(115/2)
    __button__TextSize = int(30/2)
    displayWidth = 640
    displayHeight = 480
    play(displayWidth, displayHeight)
...
def __changeRes3__():
    ...
    global __button__TextSize
    global __titleTextSize__
    __titleTextSize__ = int(144/2)
    __button__TextSize = int(38/2)
    displayWidth = 1024
    displayHeight = 600
    play(displayWidth, displayHeight)
...
def __changeRes4__():
    ...
    global __button__TextSize
    global __titleTextSize__
    __titleTextSize__ = int(216/2)
    __button__TextSize = int(56/2)
    displayWidth = 1200
    displayHeight = 900
    play(displayWidth, displayHeight)
...
def __changeRes5__():
    ...
    global __button__TextSize
    global __titleTextSize__
    __titleTextSize__ = int(259/2)
    __button__TextSize = int(68/2)
    displayWidth = 1920
    displayHeight = 1080
    play(displayWidth, displayHeight)
